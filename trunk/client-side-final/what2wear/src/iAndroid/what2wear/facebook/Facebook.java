...
public class Facebook {
     ...
     *          www.facebook.com/developers/apps.php.
     */
    public Facebook(String appId, String token, long expires) {
    	this(appId);
        this.mAccessToken = token;
        this.mAccessExpires = expires;   
    }
     ...
     * calls.
     *
     * Because this process will not be available for all friendsList, if single
